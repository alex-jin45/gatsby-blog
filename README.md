...
1.  **Improve Headings UI**
2.  **Add more Sections like Quotes, Books**
3.  **Change footer to Social links**
4.  **Add More custom CSS file for each Component**
5.  **Add More Blogs**
6.  **Improve About page**
7.  **Custom Design Logo, Icons..**
